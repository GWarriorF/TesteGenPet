...
{	
	...
	public void atualizarCadastro() {
	    ...
	    if (iFichaGato.hasNext()) {
	        CadastroAnimalGato fichaGato = iFichaGato.next();
	        System.out.println("Dados atuais da ficha de gato:");
	        System.out.println("Peso: " + fichaGato.getPeso());
	        System.out.println("Nome Tutor: " + fichaGato.getNomeDono());
	        // Exibir outros atributos da ficha de gato
	        ...
	        if (resposta.equalsIgnoreCase("S")) {
	            ...
	            fichaGato.setPeso(indiceCadastro);

	            System.out.print("Nome Tutor: ");
	            String nomeDono = ler.nextLine();
	            fichaGato.setNomeDono(nomeDono);

	            // Atualizar outros atributos da ficha de gato

	            System.out.println("Ficha de gato atualizada com sucesso.");
	        }
	    } else if (iFichaCachorro.hasNext()) {
	        CadastroAnimalCachorro fichaCachorro = iFichaCachorro.next();
	        System.out.println("Dados atuais da ficha de cachorro:");
	        System.out.println("Peso: " + fichaCachorro.getPeso());
	        System.out.println("Nome Dono: " + fichaCachorro.getNomeDono());
	        // Exibir outros atributos da ficha de cachorro
	        ...
	        if (resposta.equalsIgnoreCase("S")) {
	            ...
	            System.out.print("Peso: ");
	            double peso = Double.parseDouble(ler.nextLine());
	            fichaCachorro.setPeso(indiceCadastro);

	            System.out.print("Nome Dono: ");
	            String nomeDono = ler.nextLine();
	            fichaCachorro.setNomeDono(nomeDono);

	            // Atualizar outros atributos da ficha de cachorro

	            System.out.println("Ficha de cachorro atualizada com sucesso.");
	        }
	    } else {
	        System.out.println("Nenhuma ficha encontrada para atualizar.");
	    }
	}
